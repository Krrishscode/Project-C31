...
var arrow, arrowCount = 0, arrowSound, arrowCountSound;

function preload() {

  arrowSound = loadSound("assets/arrowS.wav")
  arrowCountSound = loadSound('assets/arrowCS.wav')
...
function draw() {
  ...
  text("ARROW COUNT: " + arrowCount, width / 2, 150);
 ...
 if (arrowCount % 10 === 0 && arrowCount > 0) {

  arrowCountSound.play();
